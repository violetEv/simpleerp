            ...
            <div class="bg-white shadow-sm rounded-lg mb-3 border border-gray-100 p-3">
                ...
                <div class="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <div class="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-md p-1">
                        ...
                        {{-- IMPORT --}}
                        <form action="{{ route('ppic.customer.import') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <button type="button" onclick="document.getElementById('importFile').click()"
                                title="Import"
                                class="h-8 w-8 flex items-center justify-center rounded bg-white text-gray-800 hover:bg-gray-200">

                                {{-- ICON UPLOAD --}}
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M4 16v1a2 2 0 002 2h12a2 2 0 002-2v-1M12 12v-8m0 0l-3 3m3-3l3 3" />
                                </svg>
