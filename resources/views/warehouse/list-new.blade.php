                                ...
                                @foreach ($travelers as $traveler)
                                    ...
                                    class="text-green-500 border-sm hover:underline ml-2">+ Buat turunan</a> --}}
                                            <button onclick="openDetail(this)"
                                                ...
                                                data-style="{{ $traveler->suratJalan->kkpo->details->first()->style->name ?? '-' }}"
                                                data-color="{{ $traveler->suratJalan->kkpo->details->first()->color->name ?? '-' }}"
                                                data-category="{{ $traveler->suratJalan->kkpo->details->first()->category->name ?? '-' }}"
