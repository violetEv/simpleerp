                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if ($order->status == 'open')
                                            <span
                                                class="px-3 py-1 text-sm font-medium bg-green-100 text-green-700 rounded-full">{{ $order->status }}</span>
                                        @else
                                            <span
                                                class="px-3 py-1 text-sm font-medium bg-red-100 text-red-700 rounded-full">{{ $order->status }}</span>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
